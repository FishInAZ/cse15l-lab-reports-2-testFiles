...
public class MarkdownParseTest {
    ...
    public void snippet1() throws IOException{
        Path file = Path.of("/Users/chenyu/Documents/GitHub/makrdown-parse/Snippet1.md");
        String content = Files.readString(file);
    ...
    public void snippet2() throws IOException{
        Path file = Path.of("/Users/chenyu/Documents/GitHub/makrdown-parse/Snippet2.md");
        String content = Files.readString(file);
        ArrayList<String> actual = MarkdownParse.getLinks(content);
        ArrayList<String> expected = new ArrayList<>();
    ...
    public void snippet3() throws IOException{
        Path file = Path.of("/Users/chenyu/Documents/GitHub/makrdown-parse/Snippet3.md");
        String content = Files.readString(file);
        ArrayList<String> actual = MarkdownParse.getLinks(content);
        ArrayList<String> expected = new ArrayList<>();
